    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <span className='lg:text-[70px] absolute  md:text-[40px]  lg:top-[10%] top-[15%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Grow Your  <span className='text-[#38D2CA]'>Skiils </span>  to Advance 
        </span>
      ...
      <button className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer' onClick={()=>navigate("/allcourses")}>View all Courses  <SiViaplay 
  className="w-8 h-8 p-1 rounded-full 
             bg-[#38D2CA] 
             text-white 
             lg:text-white lg:bg-black"
/>
</button>
